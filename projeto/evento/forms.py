...
class EventoForm(forms.ModelForm):
    ...
    class Meta:
        model = Evento
        fields = ['nome', 'tipo', 'descricao', 'site', 'instituicao', 'coordenador', 'coordenador_suplente', 'email', 'data_inicio', 'data_limite_trabalhos', 'modelo_artigo', 'arquivo_modelo', 'is_active']
